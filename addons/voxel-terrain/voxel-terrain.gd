...
func create_terrain_marker():
	...
	terrain_marker_cylinder = CylinderMesh.new();
	terrain_marker_cylinder.material = load("res://addons/voxel-terrain/materials/marker_material.tres")
	terrain_marker_cylinder.height = 2.0
